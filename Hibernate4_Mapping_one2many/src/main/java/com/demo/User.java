...
//  >>cannot use this: as i can only have 1 setter<<
	...
	@OneToMany(mappedBy="user",cascade=CascadeType.ALL)//because this is a set>>cannot create a column in table User>>instead ut creates another table(user_bankaccounts-->1-1,1-2,1-3 id's)>>to avoid this can use mapped by
