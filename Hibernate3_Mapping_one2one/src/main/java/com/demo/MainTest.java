...
public class MainTest {
	public static void main(String[] args) {
		...
		System.out.println(customer.getTransaction_Table().getTransaction_id());//2//table mdhe bhale direct 1 column ahe pn asach ascces honar id
