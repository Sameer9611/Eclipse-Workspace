...
public class EmployeeRegistration {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		String sql1 ="insert into employee(firstname,lastname,salary) values('kamj','ghogare','31000');";
		String sql2="select * from employee";
		ResultSet resultSet;
		try {
			Class.forName("com.mysql.cj.jdbc.Driver");//1)load the driver class>>tell to handle checked exception>>ClassnotFoundException>>no longer mandatory
